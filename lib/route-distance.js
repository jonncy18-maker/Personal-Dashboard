...
// geocode both ends via the same Nominatim lookup Travel already uses, then
// ask the public OSRM demo routing server for the driving distance between
// them. No API key, no paid tile provider — same "free, keyless" discipline
// as lib/geocode.js. A failed lookup at any step just means no computed
// distance; the caller lets John enter miles by hand rather than blocking
// the save.
//
