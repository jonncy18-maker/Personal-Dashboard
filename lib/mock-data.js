    ...
    trips: [
      {
        ...
        end_date: '2026-10-11',
        nights: 7,
        // NOTE: must be a real Unsplash photo ID — a made-up ID 404s in the
        // browser and every trip-photo slot silently falls back to the plain
        // accent gradient (looks like "images don't render").
        image_url:
          'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=70&auto=format&fit=crop',
        image_attribution: 'Benjamin Voros · Unsplash',
        image_source: 'auto',
      },
    ],
    schedules: {
