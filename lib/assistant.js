...
const CATALOG = [
  ...
  // ---- Mileage (Tesla lease tracker/forecaster) ----
  {
    name: 'get_mileage',
    description:
      'Full Mileage state: lease settings, the odometer log (ground truth for cumulative miles), the point-to-point trip journal, saved scenarios, usual-trip legs, favorite places, and the computed pace/checkpoint forecast.',
    method: 'GET',
    path: '/api/mileage',
    input_schema: obj({}),
  },
