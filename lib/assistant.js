...
// `today` is the caller's device date (lib/device-time.js) — the UTC server
// date read a day ahead every Eastern evening.
export function houseRules(today) {
...
export async function runAssistant({ messages, origin, today }) {
