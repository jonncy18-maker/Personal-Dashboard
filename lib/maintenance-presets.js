...
//
// `source_url` is deliberately null: the screenshot did not include the URL
// and inventing a plausible one would be the same fabrication this file
// exists to prevent. PR 2's sync fills it in from a real fetch.
const MODEL_3 = [
  {
    name: 'Rotate tires',
    interval_miles: 6250,
