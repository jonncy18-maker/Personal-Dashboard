# Roadmap Archive — 2026 H1 (pre 2026-07-15)

Dated session-log entries from this project that predate 2026-07-15, moved verbatim out of `ROADMAP.md` to keep the live log short. Current history, the open to-do list, and the design backlog all stay in `ROADMAP.md`.
